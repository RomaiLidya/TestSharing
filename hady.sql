...
-- Records of Category
-- ----------------------------
INSERT INTO "hady"."Category" VALUES (39, 'meme', '668006', NULL, 'f', '2021-12-22 08:11:26', '2021-12-22 08:11:26', NULL);
...
-- Records of Product
-- ----------------------------
INSERT INTO "hady"."Product" VALUES (2142, 'TWEETER MINI VIPER CM-006', 'PTR-3', 0, 0, 39, NULL, 'Lembar', 0, 0, 'f', 'f', 'f', '2021-12-22 08:11:44', '2021-12-22 08:11:44', NULL, 0, 0, 0);
...
SELECT setval('"hady"."Category_id_seq"', 40, true);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"hady"."LogActivity_id_seq"', 63196, true);
